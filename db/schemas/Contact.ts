...
import { nameFormat, phoneFormat, countryFormat, phoneValid } from "../validators/valContact.ts";
...
ContactSchema.path('phone').validate(phoneValid, "Phone not valid from API");
